...
I'll update this when I know what comes next.`,
  ...
  ka: {
    ...
    cta: {
      h2: "რეგისტრაცია ღიაა.",
      h2b: "დაჯავშნე ადგილი.",
      body: "ადგილები შეზღუდულია. შეიტანე განაცხადი და ჩვენი გუნდი მალევე დაგიკავშირდება.",
      btn: "რეგისტრაცია →",
    },
    footer: {
      tagline:
...
გამეორება იგივეობის გამეორება არ არის. ეს ახალი თვალით დაბრუნებაა.`,
    ...
    apply: {
      ...
      heroBody:
        "შეავსე ქვემოთ მოცემული ფორმა. 2 სამუშაო დღეში დავადასტურებთ შენს რეგისტრაციას.",
      courseLabel: "რომელ კურსზე გსურს რეგისტრაცია?",
      courses: [
        {
          value: "mixology",
          label: "მიქსოლოგია",
          sub: "6 კვირა · 12 გაკვეთილი · 450 ₾ · იწყება 14 ივლ",
        },
        {
          value: "programming",
          label: "პროგრამირება",
