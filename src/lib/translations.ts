...
I'll update this when I know what comes next.`,
  ...
  ka: {
    ...
    about: {
      ...
      h1b: "დოქტრინა",
      intro:
        "ჩვენ არ ვართ მორიგი თეორიული აკადემია. ორაბორაში სწავლის მეთოდიკა სრულებით ეფუძნება პრაქტიკასა და პრაქტიკული გამოცდილების მიღებას, რაც საგრძნობლად ამარტივებს, მალე დასაქმებას ან საკუთარი პროდუქტის შექმნას.",
      foundingLabel: "დაარსების ისტორია",
      foundingH2: "დაბადებული ცუდი გამოცდილებიდან",
      foundingParas: [
        "ორაბორა ოთხი ადამინის ცუდი გამოცდილებების ხარჯზე შეიქმნა. ოთხივეს ერთი საერთო რამ აერთიანებდა, ხშირი ფრაზები - ვერ შეძლებ, არ გამოვა, შეუძლებელია. ლიმიტაციები რომლებსაც ჩვენ არ ვაღიარებთ. ოთხი საკუთარი საქმის სპეციალისტი, რომლებაც გადავწყვიტეთ ჩვენი პრაქტიკაზე დაფუძნებული გამოცდილება გაგიზიაროთ. შევქმენით სივრცე სადაც ლიმიტაციები არ არსებობს. მსოფლიო მხოლოდ თეორიაზე არ აშენებულა, ხოლო ინოვაციები სიტყვას არ შეგიძლია არ გაუჩერებია",
      ],
      symbolLabel: "სიმბოლო",
      ...
      symbolPara2:
        "ეს სიმბოლო ავარჩიეთ, რადგან ის ზუსტად ასახავს იმას, რაც ჩვენ თქვენთვის შევქმენით. გარემო სადაც ლიმიტაციები არ არსებობს.",
