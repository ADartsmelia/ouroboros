...
განვაახლებ, როცა გავიგებ, რა მოდის შემდეგ.`,
    ...
    build: {
        ...
        lessons: [
          {
            ...
            date: "ხუთ, 16 ივლ",
            time: "20:00–22:00",
            title: "გამართვა + აირჩიე შენი სტარტაპი",
          },
          {
            num: "02",
            date: "კვი, 19 ივლ",
      ...
      faqs: [
        ...
        {
          q: "რა მექნება ბოლოს?",
          a: "განთავსებული Full-Stack პროდუქტი, რომელიც შენ ააგე, პორტფოლიო და Demo Day პრეზენტაცია.",
        },
        {
          q: "რა მჭირდება ტექნიკურად?",
          a: "მხოლოდ ლეპტოპი (ნებისმიერი OS) და დასწრება სამივე ყოველკვირეულ ლექციაზე.",
        },
      ],
      refund: {
