  ...
  ka: {
    ...
    paths: {
      ...
      items: [
        {
          tag: "ხელოვნება",
          subtitle: "ბარტენდინგის გზა",
          label: "ჩასხმის ხელოვნება",
    ...
    footer: {
      tagline:
        "ყოველი დასასრული დასაწყისია. ყოველი დასაწყისი თავის დასასრულის აჩრდილს ატარებს. ციკლი — სწორედ ეს არის არსი.",
      pathsHeader: "გზები",
      learnHeader: "ისწავლე",
      links: {
        pour: "მიქსოლოგია",
