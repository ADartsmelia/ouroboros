  ...
  en: {
      ...
      items: [
        {
          number: "I",
          title: "Destruction",
          body: "You must first dismantle the story you've told yourself about what you can and cannot do.",
        },
        {
          number: "II",
          title: "Unlocking",
          body: "The knowledge was always inside you. We provide the key, not the lock.",
        },
        {
          number: "III",
          title: "Community",
          body: "Every Seeker becomes a teacher. There is no graduation, only a changing role in the circle.",
        },
        {
          number: "IV",
          title: "Iteration",
          body: "The snake doesn't shed its skin once. It does it again and again, each time larger, each time more itself.",
        },
      ],
    },
    paths: {
    ...
    stories: {
      ...
      items: [
        {
          quote:
            "I came in thinking I needed a skill. I left understanding I had dismantled a ceiling I didn't know was there.",
          name: "Marcus R.",
          path: "Mixology · Alumni",
        },
        {
          quote:
    ...
    footer: {
      tagline:
        "Every ending is a beginning. Every beginning carries the ghost of its ending. The cycle is the point.",
      pathsHeader: "Paths",
      learnHeader: "Learn",
      links: {
...
Iteration is not repetition. It is return with new eyes.`,
    ...
    apply: {
      ...
      successBody:
        "We'll contact you within 2 business days to confirm your spot and share next steps.",
      ...
      heroBody:
        "Fill in your details below. We'll confirm your registration within 2 business days.",
      courseLabel: "Which course are you registering for?",
      courses: [
        {
          value: "mixology",
          label: "Mixology",
          sub: "6 weeks · 12 lessons · 450 ₾ · Starts Jul 14",
        },
        {
          value: "programming",
          label: "Programming",
          sub: "6 weeks · 18 lectures · 800 ₾ · Starts Jul 13",
        },
      ],
    ...
    blog: {
      ...
      newsletterBody:
        "We send one piece of writing every two weeks. It will be long, considered, and worth your time. We have never sent a product announcement.",
      ...
      posts: [
        {
          ...
          excerpt:
            "Both professions require the same core skill: the ability to read what someone actually needs rather than what they asked for. The bartender does it with a glass. The founder does it with a product.",
          readTime: "6 min",
          date: "May 28, 2026",
        },
        {
          ...
          excerpt:
            "There is no good time to start. There is only the moment you decide the cost of not starting is higher than the cost of starting badly. Most people never reach that calculation. We think about why.",
          readTime: "4 min",
          date: "May 14, 2026",
        },
        {
          ...
          excerpt:
            "Equal parts gin, Campari, and sweet vermouth. Three ingredients. No hidden complexity. The drink has existed for over a century without modification because it understood something that most products never do: restraint is a feature.",
          readTime: "5 min",
          date: "April 30, 2026",
        },
        {
          ...
          excerpt:
            "The most dangerous lie in early-stage building is the belief that shipping is a destination. It is the beginning of the conversation. The product you ship is the question. Users are the answer. Most founders have this backwards.",
          readTime: "7 min",
          date: "April 15, 2026",
        },
        {
          ...
          excerpt:
            "After enough exposure, flavor memory stops being a list and starts being a grammar. You stop asking 'what should I add' and start asking 'what is missing.' The shift from recipe-reader to diagnostician is the thing we're actually teaching.",
          readTime: "8 min",
          date: "March 28, 2026",
        },
        {
    ...
    storiesPage: {
      ...
      intro:
        "These are not testimonials. They are documents of what happens when someone stops waiting and enters the cycle. Read them slowly.",
...
The cycle did not teach me to make cocktails. It taught me what I was actually made for. The cocktails were the vehicle.`,
          ...
          quote:
            "I thought I was signing up for a hobby. I was signing up for a life.",
        },
        {
          name: "Sian Linh",
          path: "Programming",
...
Every founder should experience the moment where their assumptions collapse and they have to build from the rubble. Orabora engineered that moment for me. I'm grateful I didn't have to wait another two years for it to happen naturally.`,
          ...
          quote:
            "By week three I had 40 real users. None were friends. That had never happened before.",
        },
        {
          name: "Dayo Okafor",
          path: "Mixology",
...
I'll update this when I know what comes next.`,
          ...
          quote:
            "I am, for the first time in years, fully inside an experience rather than watching myself have one.",
        },
      ],
    },
    community: {
      ...
      roles: [
        {
          role: "Initiate",
          desc: "You have applied and been accepted. The cycle hasn't started yet. You're in the part where the anticipation is doing the work.",
        },
        {
          role: "Seeker",
          desc: "You're inside the cycle. Actively engaged in the destruction and reconstruction. This is the hardest part. It is also where the most learning happens.",
        },
        {
          role: "Alumni",
          desc: "The cycle has formally closed, but you are still in the circle. You return, contribute, teach, and begin again whenever you choose.",
        },
      ],
      ...
      features: [
        ...
        {
          title: "Instagram",
          desc: "Follow the cycle in real time. Behind-the-scenes from Demo Nights, seeker milestones, and moments from inside the chambers.",
          action: "Follow us →",
        },
        {
          title: "WhatsApp",
          desc: "Real-time conversation for active seekers and alumni. Questions get answered fast, usually by someone who just faced the same thing.",
    ...
    pour: {
      ...
      modules: [
        ...
        {
          chamber: "Chamber 4",
          title: "Chemistry Behind the Bar",
          duration: "Week 4",
          description:
            "Unusual mixes and chemistry behind the bar. Practice: applying this chemistry in real drinks.",
          skills: ["Chemistry", "Experiment", "Technique"],
        },
        {
          chamber: "Chamber 5",
          ...
          duration: "Week 5",
          description:
            "How we build flavor balance and what we need for it. Practice: making 3 modern-classic cocktails.",
          skills: ["Balance", "Flavor", "Modern Classic"],
        },
        {
          chamber: "Chamber 6",
      ...
      schedule: {
        ...
        lessons: [
          ...
          },
          {
            ...
            date: "Sun, Aug 2",
            time: "15:00–16:30",
            title: "Classification, Structure, Shake/Stir",
          },
          {
            num: "07",
            date: "Tue, Aug 4",
            time: "20:00–21:30",
            title: "Unusual Mixes and Chemistry",
          },
          {
            num: "08",
            date: "Sun, Aug 9",
          ...
          },
          {
            ...
            date: "Tue, Aug 11",
            time: "20:00–21:30",
            title: "Flavor Building and Balance",
          },
          {
            num: "10",
            date: "Sun, Aug 16",
          ...
          },
          {
            ...
            date: "Tue, Aug 18",
            time: "20:00–21:30",
            title: "Hospitality and Bar Operations",
          },
          {
            num: "12",
            date: "Sun, Aug 23",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "A live cocktail competition with a jury: 10 minutes on one cocktail, with your own music, including station setup and breakdown rules.",
        },
        {
    ...
    build: {
      ...
      stack: [
        ...
        {
          label: "Foundations & Deploy",
          items: ["Python", "Git / GitHub", "Docker"],
        },
      ],
      curriculumLabel: "The curriculum",
      curriculumH2: "Six chambers. Six weeks.",
      ...
      modules: [
        {
          chamber: "Chamber 1",
          title: "Foundations & Your Startup",
          duration: "Week 1",
          description:
            "On day one you choose the product you want to build. You set up your dev environment, learn the terminal, Git and GitHub, understand how the web works, and write your first Python code.",
          skills: ["Git / GitHub", "Terminal", "HTML / CSS", "Python basics"],
        },
        {
          chamber: "Chamber 2",
      ...
      schedule: {
        label: "Schedule",
        h2: "18 Lectures",
        start: "Starting July 13, 2026",
        recurrence:
          "Monday — 20:00–22:00 · Thursday — 20:00–22:00 · Saturday — 13:00–15:00",
        tourNote: "",
        lessons: [
          {
            num: "01",
            date: "Mon, Jul 13",
            time: "20:00–22:00",
            title: "Setup + Choose Your Startup",
          },
          {
            num: "02",
            date: "Thu, Jul 17",
          ...
          },
          {
            ...
            date: "Thu, Aug 7",
            time: "20:00–22:00",
            title: "TypeORM + PostgreSQL, REST API",
          },
          {
            num: "12",
            date: "Sat, Aug 9",
            time: "13:00–15:00",
            title: "Authorization (JWT), Guards",
          },
          {
            num: "13",
            date: "Mon, Aug 11",
            time: "20:00–22:00",
            title: "Full-Stack Feature End-to-End",
          },
          {
            num: "14",
            date: "Thu, Aug 14",
            time: "20:00–22:00",
            title: "Redis, File Uploads, Integrations",
          },
          {
            num: "15",
            date: "Sat, Aug 16",
            time: "13:00–15:00",
            title: "Internship + Client + Deployment",
          },
          {
            num: "16",
            date: "Mon, Aug 18",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Three lectures (Mon / Thu / Sat) plus near-daily project work between sessions. The pace is intensive and doesn't leave room to fall behind.",
        },
        {
          q: "Is the internship really included?",
          a: "Yes. From week 5 you work on real, live products and interact with real clients.",
        },
        {
          q: "What will I have at the end?",
          a: "A deployed full-stack product you built yourself, portfolio work, and a Demo Day presentation.",
        },
        {
          q: "What equipment do I need?",
          a: "Just a laptop (any OS) and attendance at all three weekly lectures.",
        },
      ],
      refund: {
        label: "Refund Policy",
        items: [
          "Full refund - before course starts (July 13), no questions asked.",
  ...
  ka: {
    ...
    hero: {
      ...
      h1b: "პროფესია.",
      body: "ორაბორა არ არის უბრალოდ აკადემია. ეს არის სივრცე, სადაც სწავლასთან დაკავშირებულ ყველა მითს ვანგრევთ და პრაქტიკით ვიწყებთ ახლის შენებას.",
      cta: "რეგისტრაცია →",
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          number: "II",
          title: "გახსნა",
          body: "ცოდნა ყოველთვის შენში იყო. ჩვენ გასაღებს გთავაზობთ, არა საკეტს.",
        },
        {
          number: "III",
          title: "საზოგადოება",
          body: "ყველა მაძიებელი მასწავლებელი ხდება.",
        },
        {
          number: "IV",
          title: "გამეორება",
          body: "გველი კანს ერთხელ არ იცვლის. ის ამას ისევ და ისევ აკეთებს, ყოველ ჯერ უფრო დიდი, ყოველ ჯერ უფრო თავისი.",
        },
      ],
    },
    paths: {
      ...
      items: [
        {
          ...
          subtitle: "მიქსოლოგია",
          label: "",
          desc: "მიქსოლოგია არ არის, მხოლოდ რეცეპტების ცოდნა, ეს არის იმის გაგება, რატომ ერევა ერთი სასმელი მეორეს. მიშო თავისი 8 წლიანი გამოცდილებით, გასწავლის ამ ხელობას - კლასიკური კოქტეილებიდან ახლის შექმნამდე.",
          link: "გაიგე მეტი →",
        },
        {
          tag: "ტექნოლოგიები",
          ...
          label: "",
          desc: "პრაქტიკაზე აგებული კურსი. პირველ ლექციაზე ირჩევ პროდუქტს/იდეას და ნაბიჯ-ნაბიჯ მიდიხარ მის შექმნამდე. არანაირი სიმულაციური სავარჯიშოები, მხოლოდ რეალური კოდი, რეალური ტესტირება, რეალური პროდუქტი.",
          link: "გაიგე მეტი →",
        },
      ],
    },
    stories: {
      ...
      items: [
        {
          quote:
            "მოვედი, ვფიქრობდი, რომ უნარი მჭირდებოდა. წავედი, მივხვდი, რომ დავანგრიე ჭერი, რომლის არსებობაც კი არ ვიცოდი.",
          name: "მარკუს რ.",
          path: "მიქსოლოგია · კურსდამთავრებული",
        },
        {
          quote:
    ...
    cta: {
      h2: "რეგისტრაცია ღიაა.",
      h2b: "დაჯავშნე ადგილი.",
      body: "ადგილები შეზღუდულია. შეიტანე განაცხადი და ჩვენი გუნდი მალე დაგიკავშირდება.",
      btn: "რეგისტრაცია →",
    },
    footer: {
      tagline:
        "ყოველი დასასრული დასაწყისია. ორაბორა კი ის ადგილია, სადაც ეს ყველაფერი რეალობაში ითარგმნება.",
      pathsHeader: "მიმართულებები",
      learnHeader: "ჩვენს შესახებ",
      links: {
        pour: "მიქსოლოგია",
        build: "პროგრამირება",
      ...
      ctaLabel: "შემოგვიეერთდი",
      ctaBtn: "განაცხადის გაგზავნა",
      copyright: "© 2026 ორაბორა. პრაქტიკა. პროგრესი. პროფესია.",
    ...
    about: {
      ...
      h1b: "დოქტრინა",
      intro:
        "ჩვენი სწავლების მეთოდიკა პრაქტიკაზეა დაფუძნებული -  იმისთვის, რომ ცოდნა გამოცდილებად იქცეს, გამოცდილება კი შესაძლებლობად.",
      foundingLabel: "დაარსების ისტორია",
      foundingH2: "დაბადებული გამოცდილებიდან",
      foundingParas: [
        "ორაბორა ოთხი ადამიანის გამოცდილებიდან შეიქმნა. ჩვენ ყველას ერთი საერთო ისტორია გვქონდა - ხშირად გვესმოდა ფრაზები: „ვერ შეძლებ“, „არ გამოვა“, „შეუძლებელია“. ეს ის ლიმიტაციებია, რომლებსაც ჩვენ არ ვაღიარებთ. ჩვენ ვართ ოთხი სპეციალისტი სხვადასხვა სფეროდან, რომლებმაც გადავწყვიტეთ საკუთარი პრაქტიკული გამოცდილება გაგიზიაროთ. შევქმენით სივრცე, სადაც მთავარი მოქმედებაა და არა შეზღუდვები. მსოფლიო მხოლოდ თეორიით არ შენდება - ცვლილებებსა და ინოვაციებს ყოველთვის ადამიანები ქმნიან, რომლებიც გაჩერებას არ ირჩევენ.",
      ],
      symbolLabel: "სიმბოლო",
      symbolH2: "რას ნიშნავს აქ ორაბორა",
      symbolPara1:
        "ალქიმიაში ორაბორა ყველაფრის ერთიანობას განასახიერებს - თვით ბუნების ციკლურ ბუნებას. გნოსტიკურ ტრადიციაში ის მარადისობის გველია - არც დასაწყისი, არც დასასრული. სკანდინავიურ კოსმოლოგიაში იორმუნგანდი მიდგარდს ეხვევა და სამყაროს მთლიანობას თავისი თავის შთანთქმით ინარჩუნებს.",
      symbolPara2:
        "სწორედ ამიტომ ავირჩიეთ ეს სიმბოლო. რადგან გვჯერა, რომ განვითარება იქ იწყება, სადაც ძველი ფორმები იშლება და ადგილი ახალ შესაძლებლობებს ეთმობა. ასე შევქმენით ორაბორა - სივრცე უწყვეტი ზრდისთვის.",
...
გამეორება იგივეობის გამეორება არ არის. ეს ახალი თვალით დაბრუნებაა.`,
      ...
      ctaBtn: "რეგისტრაცია →",
      ctaOutline: "გაეცანი მიმართულებებს →",
    },
    apply: {
      successLabel: "რეგისტრაცია",
      successH1: "რეგისტრაცია მიღებულია.",
      successH1b: "მალე დაგიკავშირდებით.",
      successBody:
        "2 სამუშაო დღის განმავლობაში დაგიკავშირდებით ადგილის დასადასტურებლად და შემდეგი ნაბიჯების გასაზიარებლად.",
      successMetaPre: "",
      successMetaLink1: "",
      successMetaMid: "",
      successMetaLink2: "",
      ...
      heroBody:
        "შეავსე ქვემოთ მოცემული ფორმა და 2 დღის ვადაში, ჩვენი გუნდი დაგიკავშირდება",
      courseLabel: "რომელ კურსზე გსურს რეგისტრაცია?",
      courses: [
        {
          value: "mixology",
          label: "მიქსოლოგია",
          sub: "6 კვირა · 12 გაკვეთილი · 500 ₾ · იწყება 14 ივლ",
        },
        {
          value: "programming",
          label: "პროგრამირება",
          sub: "6 კვირა · 18 ლექცია · 800 ₾ · იწყება 13 ივლ",
        },
      ],
      firstName: "სახელი",
      lastName: "გვარი",
    ...
    blog: {
      ...
      newsletterBody:
        "ჩვენ ორ კვირაში ერთხელ ვაგზავნით ერთ ტექსტს. ის გრძელი, გააზრებული და შენი დროის ღირსი იქნება. ჩვენ არასოდეს გვიგზავნია პროდუქტის შესახებ შეტყობინება.",
      ...
      posts: [
        ...
        },
        {
          ...
          excerpt:
            "დაწყების კარგი დრო არ არსებობს. არსებობს მხოლოდ მომენტი, როცა გადაწყვეტ, რომ დაუწყებლობის ფასი უფრო მაღალია, ვიდრე ცუდად დაწყების ფასი. ხალხის უმეტესობა ამ გათვლამდე არასოდეს აღწევს. ჩვენ ვფიქრობთ, რატომ.",
          readTime: "4 წთ",
          date: "May 14, 2026",
        },
        {
          ...
          excerpt:
            "თანაბარი ნაწილი ჯინი, კამპარი და ტკბილი ვერმუტი. სამი ინგრედიენტი. დამალული სირთულის გარეშე. სასმელი საუკუნეზე მეტია არსებობს ცვლილების გარეშე, რადგან მან გაიგო ის, რასაც პროდუქტების უმეტესობა ვერასოდეს იგებს: თავშეკავება ფუნქციაა.",
          readTime: "5 წთ",
          date: "April 30, 2026",
        },
        {
    ...
    storiesPage: {
      ...
      intro:
        "ეს არ არის გამოხმაურებები. ეს არის დოკუმენტები იმისა, რაც ხდება, როცა ვინმე ლოდინს წყვეტს და ციკლში შედის. წაიკითხე ნელა.",
...
ციკლმა კოქტეილების გაკეთება არ მასწავლა. მასწავლა, რისთვის ვიყავი ნამდვილად შექმნილი. კოქტეილები მხოლოდ საშუალება იყო.`,
        ...
        },
        {
          ...
          cohort: "ციკლი 5",
          status:
            "კურსდამთავრებული · ახლა: დამფუძნებელი, PaceNote (Series A მოლოდინში)",
          before: {
            title: "ციკლამდე",
...
ყველა დამფუძნებელმა უნდა განიცადოს მომენტი, როცა მისი ვარაუდები იშლება და ნანგრევებიდან უწევს შენება. ორაბორამ ეს მომენტი ჩემთვის შექმნა. მადლობელი ვარ, რომ კიდევ ორი წელი არ მომიწია ლოდინი, რომ ის ბუნებრივად მომხდარიყო.`,
          ...
          quote:
            "მესამე კვირისთვის 40 ნამდვილი მომხმარებელი მყავდა. არცერთი მეგობარი არ იყო. ეს არასოდეს მომხდარა.",
        },
        {
          name: "დაიო ოკაფორი",
          path: "ჩასხმის ხელოვნება",
...
განვაახლებ, როცა გავიგებ, რა მოდის შემდეგ.`,
          ...
          quote:
            "წლების შემდეგ პირველად, სრულად ვარ გამოცდილების შიგნით, ნაცვლად იმისა, რომ ვუყურო, როგორ მაქვს ის.",
        },
      ],
    },
    community: {
      ...
      roles: [
        {
          role: "ახალმოსული",
          desc: "შენ შეიტანე განცხადება და მიგიღეს. ციკლი ჯერ არ დაწყებულა. იმ ნაწილში ხარ, სადაც მოლოდინი ასრულებს შრომას.",
        },
        {
          role: "მაძიებელი",
          desc: "შენ ციკლის შიგნით ხარ. აქტიურად ჩართული განადგურებასა და ხელახალ შენებაში. ეს ყველაზე რთული ნაწილია. ასევე აქ ხდება ყველაზე მეტი სწავლა.",
        },
        {
          role: "კურსდამთავრებული",
          desc: "ციკლი ფორმალურად დაიხურა, მაგრამ შენ ჯერ კიდევ წრეში ხარ. ბრუნდები, წვლილს შეიტან, ასწავლი და თავიდან იწყებ, როცა აირჩევ.",
        },
      ],
      ...
      features: [
        ...
        {
          title: "Instagram",
          desc: "გამოგვყვები ციკლის რეალურ დროში. კულისებს მიღმა დემო ღამეებიდან, მაძიებლების მიღწევებიდან და კამერების შიგნიდან.",
          action: "გამოგვყვები →",
        },
        {
          title: "WhatsApp",
          desc: "რეალური დროის საუბარი აქტიური მაძიებლებისა და კურსდამთავრებულებისთვის. კითხვებს სწრაფად პასუხობენ, ჩვეულებრივ ის, ვინც სწორედ იგივე შეხვდა.",
          action: "შემოუერთდი ჩატს →",
        },
      ],
    ...
    pour: {
      ...
      whoH2: "ვისაც სურს",
      whoH2b: "მიქსოლოგია პროფესიად აქციოს.",
      whoItems: [
      ...
      priceSub: "სრული ფასი",
      pricingItems: [
        "12 პრაქტიკული გაკვეთილი (ხუთშ/კვ)",
      ...
      modules: [
        ...
        },
        {
          ...
          duration: "კვირა 4",
          description:
            "უცნაური მიქსები და ქიმია ბარის უკან. პრაქტიკა: ამ ქიმიის გამოყენება რეალურ სასმელებში.",
          skills: ["ქიმია", "ექსპერიმენტი", "ტექნიკა"],
        },
        {
          chamber: "კამერა 5",
          title: "გემოს აგება",
          duration: "კვირა 5",
          description:
            "როგორ ვსვამთ გემოვნურ ბალანსს და რა გვჭირდება ამისთვის. პრაქტიკა: 3 მოდერნ-კლასიკური კოქტეილის დამზადება.",
          skills: ["ბალანსი", "გემო", "მოდერნ კლასიკა"],
        },
        {
          chamber: "კამერა 6",
      ...
      schedule: {
        ...
        recurrence: "ხუთშაბათი - 18:00–19:30 · კვირა - 15:00–16:30",
        tourNote:
          "გასვლითი ტური: ერთ-ერთ ოთხშაბათს - ნატურალური ღვინის დეგუსტაცია Warehouse-ში.",
        lessons: [
          {
            num: "01",
            date: "ხუთშ, 16 ივლ",
          ...
          },
          {
            ...
            date: "კვი, 2 აგვ",
            time: "15:00–16:30",
            title: "კლასიფიკაცია, სტრუქტურა, შეიქი/სტირი",
          },
          {
            num: "07",
            date: "ხუთშ, 6 აგვ",
            time: "20:00–21:30",
            title: "უცნაური მიქსები და გემოები",
          },
          {
            num: "08",
            date: "კვი, 9 აგვ",
            time: "15:00–16:30",
            title: "პრაქტიკა - სასმლის ქიმია",
          },
          {
            num: "09",
            date: "ხუთშ, 13 აგვ",
            time: "20:00–21:30",
            title: "გემოს დასმა და ბალანსი",
          },
          {
            num: "10",
            date: "კვი, 16 აგვ",
            time: "15:00–16:30",
            title: "პრაქტიკა - 3 თანამედროვე-კლასიკური კოქტეილი",
          },
          {
            num: "11",
            date: "ხუთშ, 20 აგვ",
            time: "20:00–21:30",
            title: "ჰოსპითალითი და ბარის მუშაობა",
          },
          {
            num: "12",
            date: "კვი, 23 აგვ",
      ...
      instructorTags: [
        ...
        "საერთაშორისო სამუშაო გამოცდილება სხვადასხვა ტიპის ბარებში",
      ],
      instructorBio1:
        "8 წელია მიქსოლოგიაში ვარ. ვმუშაობდი სხვადასხვა ტიპის ბარში, მათ შორის ქვეყნის გარეთ. მიქსოლოგიაზე ძალიან მწირე ინფორმაცია გვაქვს საქართველოში - და სწორედ ეს მინდა შევცვალო. კოქტეილებში უამრავი ცოდნაა, რომელსაც გაგიზიარებ.",
      instructorBio2: "",
      instructorQuote: "მიქსოლოგი ადამიანი არ არსებობს - მიქსოლოგია უნარია.",
      faqLabel: "დამატებითი ინფორმაცია",
      faqH2: "ხშირად დასმული კითხვები",
      faqs: [
        {
          q: "წინასწარი გამოცდილება მჭირდება?",
          a: "არ კურსი გათვლილია ყველანაირი გამოცდილების მქონე სტუდენტებისთვის",
        },
        {
          q: "რა არის ფინალური შეჯიბრი?",
          a: "ცოცხალი კოქტეილების შეჯიბრი ჟიურის წინაშე: 10 წუთი ერთ კოქტეილზე, სტეიშენის გაშლა-დალაგების წესებით.",
        },
        {
          q: "გასვლითი ტური ფასში შედის?",
          a: "კი კურსის საფასურში გათვალისწინებულია ტურის ღირებულება",
        },
        {
          q: "რამდენი ადგილია?",
          a: "ჯგუფი მცირეა - მაქსიმუმ 10 მონაწილე, ინდივიდუალური ყურადღებისთვის.",
        },
      ],
      refund: {
        label: "თანხის დაბრუნების პოლიტიკა",
        items: [
          "სრული დაბრუნება - კურსის დაწყებამდე 3 დღით ადრე (11 ივლისი).",
          "50%-ის დაბრუნება - პირველი კვირის (პირველი 2 გაკვეთილის) დასრულებამდე.",
      ...
      ctaLabel: "მიქსოლოგია ხელოვნებაა",
      ctaH2: "შემოგვიერთდი და",
      ctaH2b: "ისწავლე კოქტეილების ნულიდან შექმნა",
      ctaBtn: "რეგისტრაცია",
      ctaOutline: "ნახე პროგრამირების მიმართულება",
    },
    build: {
      badge: "მიმართულება II - პროგრამირება",
      heroLabel: "",
      h1: "Full-Stack ინჟინერია",
      h1b: "",
      heroBody:
        "პრაქტიკაზე აგებული კურსი. პირველ ლექციაზე ირჩევ პროდუქტს/იდეას და ნაბიჯ-ნაბიჯ მიდიხარ მის შექმნამდე. არანაირი სიმულაციური სავარჯიშოები, მხოლოდ რეალური კოდი, რეალური ტესტირება, რეალური პროდუქტი.",
      heroBtn: "რეგისტრაცია",
      price: "800 ₾",
      stats: [
        ["6", "კვირა"],
      ...
      whoLabel: "ვისთვისაა ეს მიმართულება",
      whoH2: "ვისაც სურს",
      whoH2b: "პროგრამირება პროფესიად აქციოს.",
      whoItems: [
        "ვისაც სურს კოდის წერა ნულიდან ისწავლოს",
        "ვისაც უნდა რეალური პროდუქტების აწყობა",
        "ვისაც ამ მიმართულებით დასაქმება ან საკუთარი სტარტაპის აშენება აქვს გეგმაში.",
        "ვინც სწავლობს პრაქტიკით და არა დაზეპირებით.",
      ],
      pricingLabel: "ფასი",
      priceSub: "სრული ფასი",
      pricingItems: [
        "18 პრაქტიკული გაკვეთილი (ორშ/ხუთ/შაბ)",
        "ყოველკვირეული 15-წუთიანი ინდივიდუალური 1-on-1 მენტორთან",
        "სტაჟირება რეალურ, მოქმედ პროდუქტებზე",
        "კლიენტებთან მუშაობის გამოცდილება",
      ...
      stackH2: "რეალური ინსტრუმენტები. ",
      stackH2b: "რომლებსაც პროდუქტის შექმნისას იყენებენ.",
      stack: [
        {
          label: "Frontend",
          items: ["JavaScript / TypeScript", "React", "Tailwind CSS"],
        ...
        { label: "Backend", items: ["Node.js", "NestJS", "TypeORM"] },
        { label: "Infra", items: ["PostgreSQL", "Redis", "SQL"] },
        {
          label: "Deploy",
          items: ["Python", "Git / GitHub", "Docker"],
        },
      ...
      modules: [
        {
          chamber: "კამერა 1",
          title: "საფუძვლები და შენი სტარტაპი",
          duration: "კვირა 1",
          description:
            "პირველ დღეს ირჩევ პროდუქტს, რომლის აშენებაც გინდა. აგებ dev გარემოს, ეუფლები ტერმინალს, Git-სა და GitHub-ს, სწავლობ როგორ მუშაობს ვები და წერ პირველ Python კოდს.",
          skills: ["Git/GitHub", "Terminal", "HTML/CSS", "Python basics"],
        },
        {
          chamber: "კამერა 2",
        ...
        {
          chamber: "კამერა 5",
          title: "Full-Stack, სტაჟირება, Deploy",
          duration: "კვირა 5",
          description:
            "frontend-ს უკავშირებ backend-ს თავიდან ბოლომდე, ამატებ Redis ქეშირებას და ფაილების ატვირთვას. იწყება სტაჟირება, პირველი კლიენტის სამუშაო და deployment-ის საფუძვლები (Docker).",
          skills: ["Full-stack", "Redis", "Docker", "Deployment"],
        },
        {
          chamber: "კამერა 6",
      ...
      instructorLabel: "შენი ინსტრუქტორი",
      instructorName: "ანრი",
      instructorRole: "Full-Stack & AI ინჟინერი",
      instructorBio1:
        "6+ წლიანი გამოცდილებით, ვაშენებ Web და AI სისტემებს - სპორტული overlay პლატფორმებიდან NLP სარეკომენდაციო სისტემებამდე. ვმუშაობ Setanta Sports-ში, დავაფუძნე Dining-პროდუქტი Choiso. ვასწავლიდი Python-ს, JavaScript-სა და Full-Stack-ს - სწორედ იმ უნარები, რომლებიც სამსახურისთვის გჭირდება.",
      instructorBio2: "",
      instructorQuote:
      ...
      instructorCreds: [
        ...
        "Full-Stack ინჟინერი Setanta Sports-ში",
        "დამფუძნებელი (Choiso, VisionQuest) და გამოცდილი ლექტორი Python/JS/Full-Stack-ში",
      ],
      schedule: {
        label: "განრიგი",
        h2: "18 ლექცია",
        start: "დაწყება: 13 ივლისი 2026",
        recurrence:
          "ორშაბათი - 20:00–22:00 · ხუთშაბათი - 20:00–22:00 · შაბათი - 13:00–15:00",
        tourNote: "",
        lessons: [
          {
            num: "01",
            date: "ორშ, 13 ივლ",
            time: "20:00–22:00",
            title: "შესავალი + აირჩიე შენი სტარტაპი",
          },
          {
            num: "02",
            date: "ხუთ, 17 ივლ",
            time: "20:00–22:00",
            title: "როგორ მუშაობს ვები; HTML/CSS",
          },
          {
            num: "03",
            date: "შაბ, 19 ივლ",
            time: "13:00–15:00",
            title: "Python-ის საფუძვლები",
          },
          {
            num: "04",
            date: "ორშ, 21 ივლ",
          ...
          },
          {
            ...
            date: "შაბ, 26 ივლ",
            time: "13:00–15:00",
            title: "PostgreSQL და SQL",
          },
          {
            num: "07",
            date: "ორშ, 28 ივლ",
            time: "20:00–22:00",
            title: "JavaScript და TypeScript",
          },
          {
            num: "08",
            date: "ხუთ, 31 ივლ",
          ...
          },
          {
            ...
            date: "ორშ, 4 აგვ",
            time: "20:00–22:00",
            title: "Node.js + NestJS არქიტექტურა",
          },
          {
            num: "11",
            date: "ხუთ, 7 აგვ",
          ...
          },
          {
            ...
            date: "შაბ, 9 აგვ",
            time: "13:00–15:00",
            title: "ავტორიზაცია (JWT), guards",
          },
          {
            num: "13",
            date: "ორშ, 11 აგვ",
            time: "20:00–22:00",
            title: "Full-Stack ფუნქცია თავიდან ბოლომდე",
          },
          {
            num: "14",
            date: "ხუთ, 14 აგვ",
            time: "20:00–22:00",
            title: "Redis, ფაილების ატვირთვა, ინტეგრაციები",
          },
          {
            num: "15",
            date: "შაბ, 16 აგვ",
            time: "13:00–15:00",
            title: "სტაჟირება + კლიენტი + deployment",
          },
          {
            num: "16",
            date: "ორშ, 18 აგვ",
          ...
          },
          {
            ...
            date: "ხუთ, 21 აგვ",
            time: "20:00–22:00",
            title: "გაპრიალება, QA, უსაფრთხოება",
          },
          {
            num: "18",
            date: "შაბ, 23 აგვ",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "სამი ლექცია (ორშ/ხუთ/შაბ) + თითქმის ყოველდღიური მუშაობა პროექტზე ლექციებს შორის. ტემპი ინტენსიურია და ჩამორჩენის საშუალებას არ ტოვებს.",
        },
        {
          q: "სტაჟირება მართლა ჩართულია?",
          a: "დიახ. მე-5 კვირიდან მუშაობ რეალურ, მოქმედ პროდუქტებზე და ესაუბრები რეალურ კლიენტებს.",
        },
        {
          q: "რას ვიღებ, დამთავრების შემდეგ?",
          a: "განთავსებულ Full-Stack პროდუქტს, რომელიც შენით ააწყვე, პორტფოლიოს და Demo Day პრეზენტაციას.",
        },
        {
          q: "რა მჭირდება ტექნიკურად?",
          a: "მხოლოდ ლეპტოპი (ნებისმიერი OS) და დასწრება ყოველკვირეულ ლექციებზე.",
        },
      ],
      refund: {
        label: "რეფანდის პოლიტიკა",
        items: [
          "სრული დაბრუნება - კურსის დაწყებამდე 3 დღით ადრე (13 ივლისი), კითხვების გარეშე.",
          "50%-ის დაბრუნება - პირველი კვირის (პირველი 3 ლექციის) დასრულებამდე.",
      ...
      ctaLabel: "პროგრამირება ხელოვნებაა",
      ctaH2: "შემოგვიერთდი და",
      ctaH2b: "შენი იდეა 6 კვირაში აქცია რეალურ პროდუქტად",
      ctaBtn: "რეგისტრაცია",
      ctaOutline: "ნახე მიქსოლოგიის მიმართულება",
    },
  },
};
