    ...
    apply: {
      ...
      courses: [
        ...
        },
        {
          value: "programming",
          label: "Programming",
          sub: "6 weeks · 18 lectures · 800 ₾ · Starts Jul 16",
        },
      ],
    ...
    build: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Three lectures (Mon / Wed / Sat) plus near-daily project work between sessions. The pace is intensive and doesn't leave room to fall behind.",
        },
        {
    ...
    apply: {
      ...
      courses: [
        ...
        },
        {
          value: "programming",
          label: "პროგრამირება",
          sub: "6 კვირა · 18 ლექცია · 800 ₾ · იწყება 16 ივლ",
        },
      ],
      firstName: "სახელი",
      lastName: "გვარი",
...
განვაახლებ, როცა გავიგებ, რა მოდის შემდეგ.`,
    ...
    build: {
      ...
      priceSub: "სრული ფასი",
      pricingItems: [
        "18 პრაქტიკული გაკვეთილი (სამშ/ხუთ/კვ)",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "სამი ლექცია (სამშ/ხუთ/კვ) + თითქმის ყოველდღიური მუშაობა პროექტზე ლექციებს შორის. ტემპი ინტენსიურია და ჩამორჩენის საშუალებას არ ტოვებს.",
        },
        {
