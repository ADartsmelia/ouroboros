    ...
    <div style={{ background: "var(--bg-primary)" }}>
      ...
      <section className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            <Link href="/apply?path=pour" className="btn-primary animate-breathe">
              {tr.pour.heroBtn}
            </Link>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <ScrollReveal delay={0.15}>
            ...
            <div className="card-glow p-8" style={{ background: "var(--bg-card)" }}>
              ...
              <Link href="/apply?path=pour" className="btn-primary w-full text-center block">
                {tr.pour.applyBtn}
              </Link>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <ScrollReveal className="mb-12">
            <p className="section-label">{tr.pour.curriculumLabel}</p>
            <h2 className="text-3xl font-bold" style={{ color: "var(--text-primary)" }}>
              {tr.pour.curriculumH2}<br />
              <span className="gradient-text">{tr.pour.curriculumH2b}</span>
            </h2>
          </ScrollReveal>
            ...
            {modules.map((mod, i) => (
              <ScrollReveal key={i} delay={i * 0.05}>
                <div
                  ...
                  style={{
                    borderColor: openModule === i ? "rgba(201,168,76,0.5)" : "var(--border-subtle)",
                    background: "var(--bg-card)",
                    boxShadow: openModule === i ? "0 0 20px rgba(201,168,76,0.1)" : "none",
